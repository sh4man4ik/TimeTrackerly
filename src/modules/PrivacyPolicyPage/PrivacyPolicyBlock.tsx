function PrivacyPolicyBlock() {
	return (
		<>
			<div className="mt-[45px] lg:mt-[90px] mb-[30px] lg:mb-[50px] max-w-[450px] lg:max-w-[900px] w-[90%] h-auto justify-self-center grid gap-[7px] lg:gap-[15px] font-small text-justify">
				<p className="font-medium font-bold">Privacy Policy</p>
				<p>
				...
				<p className="font-medium font-bold mt-[17px] lg:mt-[35px]">Data We Collect</p>
				<p>
				...
				<p className="font-medium font-bold mt-[17px] lg:mt-[35px]">Use of Data</p>
				<p>
				...
				<p className="font-medium font-bold mt-[17px] lg:mt-[35px]">Data Storage</p>
				<p>
				...
				<p className="font-medium font-bold mt-[17px] lg:mt-[35px]">Data Sharing</p>
				<p>
				...
				<p className="font-medium font-bold mt-[17px] lg:mt-[35px]">User Rights</p>
				<p>
				...
				<p className="font-medium font-bold mt-[17px] lg:mt-[35px]">Open Source</p>
				<p>
				...
				<p className="font-medium font-bold mt-[17px] lg:mt-[35px]">Contact</p>
				<p>
